		...
		"branch_a": {
			...
			"tiers": [
				...
				{"name": "76mm Upgrade", "cost": 400,
				 "desc": "+50% damage. Tungsten-core HVAP rounds defeat Panther armor (pierces).",
				 "damage_mult": 1.5, "bonus_vs_armor": 1.5, "pierce_armor": true},
		...
		"branch_b": {
			...
			"tiers": [
				...
				{"name": "D-Day Strike", "cost": 1400,
				 "desc": "+50% damage. AoE knocks enemies 40 px back. The largest amphibious invasion in history.",
				 "damage_mult": 1.5, "knockback": 40.0},
			],
		},
	},
	&"churchill": {
		...
		"branch_a": {
			...
			"tiers": [
				...
				{"name": "White Death", "cost": 1000,
				 "desc": "+100% damage. Instantly kills targets below 100 HP.",
				 "damage_mult": 2.0, "instakill_below_hp": 100.0},
			],
		},
		"branch_b": {
			"name": "Counter-sniper",
			"tiers": [
				...
				{"name": "Pinned Down", "cost": 500,
				 "desc": "+60% fire rate. +25% range. Hits slow targets to 50% speed for 2s.",
				 "fire_rate_mult": 1.6, "range_mult": 1.25,
				 "slow_factor": 0.5, "slow_duration": 2.0},
				{"name": "Behind Lines", "cost": 1000,
				 "desc": "+50% fire rate. +25% range. Hits 2 extra targets per shot.",
				 "fire_rate_mult": 1.5, "range_mult": 1.25, "extra_targets": 2},
			],
		},
	},
}
